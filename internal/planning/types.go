...
// PackagePresence is a transient execution-time provider-specific package presence result.
...
type PlanStep struct {
	...
	// PackagePresence is set only on an execution-plan copy after confirmed provider probing.
